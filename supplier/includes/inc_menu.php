...
//shanchu   $modules['04_order']['09_delivery_order']           = 'order.php?act=delivery_list';
...
//shanchu   $modules['05_dianpu_manage']['02_menu']               	= 	'navigator.php?act=list';
$modules['05_dianpu_manage']['03_guanggao']             = 	'flashplay.php?act=list';
//shanchu   $modules['05_dianpu_manage']['04_article']              = 	'article.php?act=list';
//shanchu   $modules['05_dianpu_manage']['05_header']               = 	'shop_header.php?act=list_edit';
//shanchu   $modules['05_dianpu_manage']['06_templates']            = 	'template.php?act=list';
//shanchu   $modules['05_dianpu_manage']['07_street']				= 	'street.php?act=info';
