...
E_D("replace into `ecs_ecsmart_shop_config` values('101','1','shop_name','text','','','京东','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('102','1','shop_title','text','','','京东(JD.COM)-综合网购首选-正品低价、品质保障、配送及时、轻松购物！','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('103','1','shop_desc','text','','','京东JD.COM-专业的综合网上购物商城,销售家电、数码通讯、电脑、家居百货、服装服饰、母婴、图书、食品等数万个品牌优质商品.便捷、诚信的服务，为您提供愉悦的网上购物体验!','1');");
...
E_D("replace into `ecs_ecsmart_shop_config` values('115','1','service_phone','text','','','051263866456','1');");
...
E_D("replace into `ecs_ecsmart_shop_config` values('501','5','smtp_host','text','','','localhost','1');");
...
E_D("replace into `ecs_ecsmart_shop_config` values('507','5','mail_service','select','0,1','','0','0');");
