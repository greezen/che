...
E_D("replace into `ecs_ecsmart_menu` values('10','附近店铺','images/201603/1458379510825667230.png','supplier_near.php','8');");
E_D("replace into `ecs_ecsmart_menu` values('11','预售活动','images/201605/1462529513327111190.png','pre_sale.php','11');");
E_D("replace into `ecs_ecsmart_menu` values('12','拍卖活动','images/201605/1462529532929607713.png','auction.php','12');");
