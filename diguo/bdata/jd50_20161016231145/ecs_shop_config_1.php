...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','京东','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','京东(JD.COM)-综合网购首选-正品低价、品质保障、配送及时、轻松购物！','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','京东JD.COM-专业的综合网上购物商城,销售家电、数码通讯、电脑、家居百货、服装服饰、母婴、图书、食品等数万个品牌优质商品.便捷、诚信的服务，为您提供愉悦的网上购物体验!','1');");
...
E_D("replace into `ecs_shop_config` values('106','1','shop_province','manual','','','22','1');");
E_D("replace into `ecs_shop_config` values('107','1','shop_city','manual','','','283','1');");
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','京东','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','800007396','1');");
E_D("replace into `ecs_shop_config` values('110','1','ww','text','','','ecshop','1');");
...
E_D("replace into `ecs_shop_config` values('114','1','service_email','text','','','68ecshop@qq.com','1');");
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','400-0785268','1');");
...
E_D("replace into `ecs_shop_config` values('503','5','smtp_user','text','','','wpw0113@163.com','1');");
E_D("replace into `ecs_shop_config` values('504','5','smtp_pass','password','','','peng2008','1');");
E_D("replace into `ecs_shop_config` values('505','5','smtp_mail','text','','','wpw0113@163.com','1');");
...
E_D("replace into `ecs_shop_config` values('150','1','erweima_wapurl','text','','','http://127.0.0.9/goods.php?id={id}','1');");
