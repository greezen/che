...
$modules['02_cat_and_goods']['01_goods_list'] = 'goods.php?act=car_list'; // 商品列表
...
/* 晒单插件 增加  */
// shanchu   $modules['02_cat_and_goods']['05_shaidan_manage'] = 'shaidan.php?act=list';
//shanchu    $modules['02_cat_and_goods']['05_goods_tags'] = 'goods_tags.php?act=list';
/* 晒单插件 增加  */
...
//shanchu   $modules['02_cat_and_goods']['17_tag_manage'] = 'tag_manage.php?act=list';
/*
 ...
 */
//shanchu   $modules['02_cat_and_goods']['goods_auto'] = 'goods_auto.php?act=list';
// shanchu   $modules['02_cat_and_goods']['scan_store'] = 'scan.php?act=insert';

/* $modules['03_promotion']['02_snatch_list'] = 'snatch.php?act=list'; */
//shanchu   $modules['03_promotion']['04_bonustype_list'] = 'bonus.php?act=list';
// $modules['03_promotion']['06_pack_list'] = 'pack.php?act=list';
// $modules['03_promotion']['07_card_list'] = 'card.php?act=list';
//shanchu   $modules['03_promotion']['08_group_buy'] = 'group_buy.php?act=list';
//shanchu   $modules['03_promotion']['09_topic'] = 'topic.php?act=list';
//shanchu   $modules['03_promotion']['10_auction'] = 'auction.php?act=list';
//shanchu   $modules['03_promotion']['12_favourable'] = 'favourable.php?act=list';
// $modules['03_promotion']['13_wholesale'] = 'wholesale.php?act=list';
//shanchu   $modules['03_promotion']['14_package_list'] = 'package.php?act=list';
...
//shanchu   $modules['03_promotion']['25_pre_sale_list'] = 'pre_sale.php?act=list'; // 预售
...
//shanchu   $modules['04_order']['05_edit_order_print'] = 'order.php?act=templates';
//shanchu   $modules['04_order']['06_undispose_booking'] = 'goods_booking.php?act=list_all';
...
/* 代码添加_START */
//shanchu   $modules['06_stats']['keyword'] = 'keyword.php?act=list'; // 客户搜索记录
/* 代码添加_SEND By  */
...
//shanchu   $modules['07_content']['vote_list'] = 'vote.php?act=list';
//shanchu   $modules['07_content']['article_auto'] = 'article_auto.php?act=list';
...
//shanchu   $modules['08_members']['06_list_integrate'] = 'integrate.php?act=list';
//shanchu   $modules['08_members']['08_unreply_msg'] = 'user_msg.php?act=list_all';
...
//shanchu   $modules['08_members']['09_postman_list'] = 'postman.php?act=list';
...
//shanchu   $modules['10_priv_admin']['agency_list'] = 'agency.php?act=list';
//shanchu   $modules['10_priv_admin']['suppliers_list'] = 'suppliers.php?act=list'; // 供货商

$modules['11_system']['01_shop_config'] = 'shop_config.php?act=list_edit';
//shanchu   $modules['11_system']['shop_authorized'] = 'license.php?act=list_edit';
...
//shanchu   $modules['11_system']['07_cron_schcron'] = 'cron.php?act=list';
//shanchu   $modules['11_system']['08_friendlink_list'] = 'friend_link.php?act=list';
//shanchu   $modules['11_system']['sitemap'] = 'sitemap.php';
//shanchu   $modules['11_system']['check_file_priv'] = 'check_file_priv.php?act=check';
...
//shanchu   $modules['11_system']['navigator'] = 'navigator.php?act=list';   //zidingyidaohanglan
//shanchu   $modules['11_system']['file_check'] = 'filecheck.php';
...
//shanchu   $modules['14_sms']['03_sms_send'] = 'sms.php?act=display_send_ui';
...
*/
//shanchu   $modules['16_email_manage']['email_list'] = 'email_list.php?act=list';
//shanchu   $modules['16_email_manage']['magazine_list'] = 'magazine_list.php?act=list';
//shanchu   $modules['16_email_manage']['attention_list'] = 'attention_list.php?act=list';
...
$modules['16_email_manage']['03_sms_send'] = 'sms.php?act=display_send_ui';

/* 代码增加_start  */
//shanchu   $modules['02_supplier']['06_supplier_tag'] = 'supplier_tag.php?act=list';
...
//shanchu   $modules['02_supplier']['04_shop_category'] = 'supplier_street_category.php?act=list';
//shanchu   $modules['02_supplier']['05_shop_street'] = 'supplier_street.php?act=list';
/* 代码增加_end By  */
...
/* 代码增加_start By  */
//shanchu   $modules['03_promotion']['16_takegoods_list'] = 'takegoods.php?act=list';
//shanchu   $modules['03_promotion']['16_takegoods_order'] = 'takegoods.php?act=order_list';
/* 代码增加_end By  */
$modules['16_email_manage']['sendmail'] = 'sendmail.php?act=sendmail';
/* 代码增加_start By  */
//shanchu   $modules['02_cat_and_goods']['pricecut'] = 'pricecut.php?act=list&status=-1';
...
/* 代码增加_start By  */
//shanchu   $modules['03_promotion']['19_valuecard_list'] = 'valuecard.php?act=list';
