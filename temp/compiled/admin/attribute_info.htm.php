...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      ...
      <!--增加条形码选择开始 0不显示 1显示-->
      <tr>
      	<td class="label"><?php echo $this->_var['lang']['label_txm_type']; ?>：</td>
       	<td>
        	<input type="radio" name="attr_txm" value="0" <?php if ($this->_var['attr']['attr_txm'] == 0): ?> checked="true" <?php endif; ?> /><?php echo $this->_var['lang']['no']; ?>
            <input type="radio" name="attr_txm" value="1" <?php if ($this->_var['attr']['attr_txm'] == 1): ?> checked="true" <?php endif; ?> /><?php echo $this->_var['lang']['yes']; ?>
          </td>
       </tr>
       <!--增加条形码选择结束 0不显示 1显示-->
	  ...
	  <!--代码增加_start By www.ecshop68.com-->
		<tr>
        <td class="label"><font color=#ff3300>是否启用属性相册：</font></td>
        <td>
          <input type="radio" name="is_attr_gallery" value="1" <?php if ($this->_var['attr']['is_attr_gallery'] == 1): ?>checked=checked<?php endif; ?>>启用
		  <input type="radio" name="is_attr_gallery" value="0" <?php if ($this->_var['attr']['is_attr_gallery'] == 0): ?>checked=checked<?php endif; ?>>不启用
		  <br /><span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> >注意每个商品类型下只能有一个属性被启用“属性相册”</span>
        </td>
      </tr>
